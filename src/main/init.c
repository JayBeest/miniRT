...
t_err	init_temp_scene(t_minirt *rt)
{
	...
	rt->scene.shapes = new_sphere(250, (t_vector){-150, -80, 800}, (t_color){230, 0, 38, 255}, 2000);//RED
	rt->scene.shapes->next = new_sphere(250, (t_vector){50, 20, 900}, (t_color){90, 187, 238, 255}, 800);//BLUE
	...
	rt->scene.shapes->next->next->next->next->next = new_plane((t_vector){-1, -600, 1000}, (t_vector){-0.1, -0.8, 0.1}, (t_color){178, 132, 190, 255}, 100);
	...
	rt->scene.lights->next->next = new_direct_light(0.3, (t_vector){0.1, 0.8, 0}, (t_color){255 ,255 ,255 ,255});
