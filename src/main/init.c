...
/*   Updated: 2022/04/27 16:03:46 by jcorneli      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
t_err	init_temp_scene(t_minirt *rt)
{
	...
	rt->scene.shapes = new_sphere(250, (t_vector){0, -100, 800}, (t_color){230, 0, 38, 255}, 100);//RED
	rt->scene.shapes->next = new_sphere(250, (t_vector){200, 0, 900}, (t_color){43, 0, 255, 255}, 100);//BLUE
	rt->scene.shapes->next->next = new_sphere(600, (t_vector){-300, -200, 1250}, (t_color){102, 255, 153, 255}, 100);//GREEN
	rt->scene.shapes->next->next->next = new_sphere(380, (t_vector){250, -350, 900}, (t_color){255, 255, 77, 255}, 100);//YELLOW
