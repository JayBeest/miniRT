...
t_err	init_temp_scene(t_minirt *rt)
{
	...
	rt->scene.shapes->next->next->next = new_sphere(380, (t_vector){100, -360, 900}, (t_color){255, 255, 77, 255}, 500);//YELLOW
...
//	rt->scene.shapes->next->next->next->next->next = new_plane((t_vector){-1, -630, 1000}, (t_vector){-0.1, -0.8, 0.1}, (t_color){255, 255, 255, 255}, 100);
	...
	rt->scene.lights = new_point_light(0.4, (t_vector){-50, 180, 200}, (t_color){0 ,255 ,255 ,255});
	rt->scene.lights->next = new_point_light(0.35, (t_vector){200, 50, 100}, (t_color){255 ,255 ,0 ,255});
	rt->scene.lights->next->next = new_direct_light(0.55, (t_vector){2.5, 4.7, 3}, (t_color){255, 255 ,255 ,255});
	rt->scene.lights->next->next->next = new_point_light(0.35, (t_vector){-400, -300, 200}, (t_color){255 ,255 ,255 ,255});
